...
struct heart:Shape {
    func path(in rect:CGRect)->Path{
        Path{(path) in
            ...
            path.addArc(center: CGPoint(x: 0, y: 0), radius: rect.width, startAngle: .degrees(0), endAngle: .degrees(180), clockwise: true)
            path.addArc(center: CGPoint(x: 2*rect.width, y: 0), radius: rect.width, startAngle: .degrees(0), endAngle: .degrees(180), clockwise: true)
            path.addLine(to: CGPoint(x: 3*rect.width, y: 0))
            path.addLine(to: CGPoint(x: rect.width, y: 2*rect.width))
            path.addLine(to: CGPoint(x: 0-rect.width, y: 0))
            path.closeSubpath()
        }
    }
}
        ...
        ZStack {
            ...
            Group{
                ...
                heart()
                    ...
                    .position(x: 70, y: 750)
                heart()
                    .fill(Color(red: 1, green: 0.9, blue: 0.0))
                ...
                heart()
                    .fill(Color(red: 1, green: 0.7, blue: 0.8))
            ...
            Group{
                ...
                Path({path in
                    ...
                    path.addQuadCurve(to: CGPoint(x: 146, y: 738), control: CGPoint(x: 170, y: 635))
                    path.addQuadCurve(to: CGPoint(x: 188, y: 772), control: CGPoint(x: 190, y: 735))
                    path.addLine(to: CGPoint(x: 244, y: 772))
                    path.addQuadCurve(to: CGPoint(x: 290, y: 740), control: CGPoint(x: 254, y: 726))
                })
                ...
                Path({path in
                    ...
                    path.addQuadCurve(to: CGPoint(x: 274, y: 737), control: CGPoint(x: 239, y: 737))
                    path.addQuadCurve(to: CGPoint(x: 245, y: 769), control: CGPoint(x: 248, y: 751))
                })
                .fill(Color(red: 0.95, green: 0.7, blue: 0.8))
            ...
            Group{
                ...
                Path({path in
                    ...
                    path.addQuadCurve(to: CGPoint(x: 201, y: 649), control: CGPoint(x: 200, y: 640))
                    path.addLine(to: CGPoint(x: 238, y: 649))
                    path.addQuadCurve(to: CGPoint(x: 248, y: 639), control: CGPoint(x: 240, y: 640))
                })
                .fill(/*@START_MENU_TOKEN@*/Color.white/*@END_MENU_TOKEN@*/)
                //face line
                Path({path in
